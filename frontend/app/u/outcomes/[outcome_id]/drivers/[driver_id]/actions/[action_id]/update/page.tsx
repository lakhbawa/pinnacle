...
export default function UpdateAction({params}: {
    params: Promise<{ outcome_id: string, driver_id: string, action_id: string }>
}) {
    ...
    const updateAction = async (event: React.FormEvent) => {
        ...
        try {
          ...
          // Convert scheduled_for to ISO-8601 format if it exists
        const submitData = {
            ...formData,
            ...
            await outcomeAPI.patch(`/actions/${action_id}`, submitData);
            router.push(`/u/outcomes/${outcome_id}/drivers/${driver_id}/actions/${action_id}`);
        } catch (error) {
        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="md:flex md:items-center md:justify-between md:space-x-4 mb-8">
                    ...
                    <Link
                        href={`/u/outcomes/${outcome_id}/drivers/${driver_id}/actions/${action_id}`}
